...
def validate_training_data(model_dir='models/v39'):
    """验证训练数据完整性"""
    print("\n" + "="*80)
    print("📊 验证1: 训练数据完整性")
    print("="*80)
...
def validate_model_files(model_dir='models/v39'):
    """验证模型文件存在性"""
    print("\n" + "="*80)
    print("📁 验证2: 模型文件完整性")
    print("="*80)
...
def validate_feature_importance(model_dir='models/v39'):
    """验证特征重要性"""
    print("\n" + "="*80)
    print("🎯 验证5: 特征重要性分析")
    print("="*80)
...
def validate_training_info(model_dir='models/v39'):
    """验证训练信息"""
    print("\n" + "="*80)
    print("📋 验证6: 训练信息")
    print("="*80)
