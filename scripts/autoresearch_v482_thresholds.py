#!/usr/bin/env python3
"""
V4.8.2 阈值优化评估脚本 — autoresearch 用

评估指标: 综合得分 = 加权(各周期 强烈买入 利润因子)
参数文件: scripts/autoresearch_v482_threshold_params.json
...
PARAMS_FILE = PROJECT_ROOT / 'scripts' / 'autoresearch_v482_threshold_params.json'
DATA_FILE = '/tmp/v482_full_backtest.pkl'
