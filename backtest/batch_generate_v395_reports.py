...
def get_trading_dates(start_date: str, end_date: str, version: str = 'v3.95') -> List[str]:
    """从特征缓存获取交易日列表"""
    _ng_tables = {'ng1.0.0': 'ng_feature_cache', 'ng1.0.1': 'ng101_feature_cache', 'ng1.0.2': 'ng102_feature_cache'}
...
def score_all_stocks_from_preloaded(
    ...
    if version in ('ng1.0.0', 'ng1.0.1', 'ng1.0.2'):
        all_codes = features_df['code'].tolist()
        return scorer.predict_scores(all_codes, date)

    if version in ('v4.8.3', 'v4.8.4', 'v4.8.5', 'v4.8.6', 'v4.8.7', 'v4.9.0', 'v4.9.0.1', 'v4.9.0.2', 'v4.9.1', 'v4.9.2', 'v4.9.3', 'v4.9.3a', 'v4.9.3b', 'v4.9.3c'):
        all_codes = features_df['code'].tolist()
        return scorer.predict_scores(all_codes, date)
...
def main():
    ...
    parser.add_argument('--version', default='v3.95',
                        choices=['v3.9', 'v3.95', 'v3.96', 'v4.3', 'v4.4', 'v4.4.2', 'v4.6', 'v4.7', 'v4.7.1', 'v4.7.2', 'v4.7.3', 'v4.7.4', 'v4.7.5', 'v4.7.6', 'v4.7.7', 'v4.7.8', 'v4.7.9', 'v4.8.0', 'v4.8.1', 'v4.8.2', 'v4.8.3', 'v4.8.4', 'v4.8.5', 'v4.8.6', 'v4.8.7', 'v4.8.8', 'v4.9.0', 'v4.9.0.1', 'v4.9.0.2', 'v4.9.1', 'v4.9.2', 'v4.9.3', 'v4.9.3a', 'v4.9.3b', 'v4.9.3c', 'v5.0', 'alpha158', 'ng1.0.0', 'ng1.0.1', 'ng1.0.2'],
    ...
    elif args.version == 'v4.9.3a':
        from ml_models.v39.v493a_production_scorer import V493AProductionScorer
        scorer = V493AProductionScorer(model_type='small_data')
