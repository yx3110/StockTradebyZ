...
class V390VisualizedTrainer:
    ...
    def __init__(self, db_path='data_adapter/stock_data.db', output_dir='reports/v39_training'):
...
def main():
    ...
    parser.add_argument('--output-dir', type=str, default='models/v39')
    parser.add_argument('--viz-dir', type=str, default='reports/v39_training')
