...
def test_version_table_map_ng130():
    assert get_table_name('ng1.3.0') == 'ng130_feature_cache'
...
def test_ng130_schema_has_downside_columns():
    sql = _schema_sql('ng130_feature_cache', version='ng1.3.0')
...
def test_create_ng130_table_succeeds():
    ...
    try:
        ...
        with sqlite3.connect(db_path) as conn:
            ...
            assert 'ng130_feature_cache' in tables
    finally:
        os.unlink(db_path)
