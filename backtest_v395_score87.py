...
def generate_markdown_report(df, analysis_results, output_file):
    ...
    with open(output_file, 'w', encoding='utf-8') as f:
        ...
        f.write(f"**数据范围**: {df['select_date'].min()} ~ {df['select_date'].max()}\n\n")
