...
| V5.2 (WF-OOS) | 72.1% A+ (重测 73.4%) | **≥72%** 保住水平 |
| V5.2 (Pre-2020) | ~~73.7% A+~~ **45.5% B** (2026-04-20 订正, 原为 4-10 评估 bug 遗留 ghost number) | **≥40%** 同向 alpha (放宽, Pre-2020 对 bugfix pkl regime 差) |
...
| 版本 | Pre-2020 V5.2 (旧数字, 4-20 前) | 2026-04-20 订正后 | 结局 |
|---|---:|---:|---|
| ng1.0.1 (4-12 bugfix) | ~~73.7% A+~~ | **45.5% B** | ✅ 基线, 单边 WF-OOS A+ |
| ng1.0.3 | 55.5% B | 待复核 | 勉强 |
| ng1.0.4 (RA label) | 45.5% **C** | 待复核 | 失败 |
| ng1.0.7 (条件 label) | 41.0% **C** | 待复核 | 失败 |
| ng1.2.3 (contrarian) | 31% **D** | 待复核 | 双崩 |

**Pre-2020 Gate 口径调整** (2026-04-20): 原 65% A 级阈值基于 ng1.0.1 "73.7% A+" 的 ghost number 推导, 已证伪。新基线为 45.5% B, 后续迭代 Pre-2020 Gate 改为 **"同向 alpha 验证": 净年化 ≥ 0% 且超额胜率 ≥ 60%** (不再追求 A/A+)。
...
- ✅ Pre-2020 V5.2 ≥ 50% + 净年化 ≥ 10% (超越 ng1.0.1 45.5% B 基线, 实现真正跨 regime alpha)

→ 建立新的跨 regime 稳健基座, ng1.0.1 退役。
