...
**比较基准**：所有"退步 / 不退步"判断对比 **ng1.0.1 bugfix**（Sharpe=2.753, MaxDD=-11.7%, 年化=165.7%, V5.2=72.1% A+, 10d WF ICIR=0.931, 15d=1.060, Pre-2020 V5.2=73.7% A+）。
