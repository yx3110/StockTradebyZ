...
Bug修复效果对比 (同时段 **2024-2026 WF-OOS**, 10d持仓, composite排名):

| 指标 | ng1.0.1原版 (4-05 pkl) | ng1.0.1 bugfix (4-12 pkl) | ng1.1.0 bugfix |
|---|---|---|---|
| V5.2 | 73.7% A+ | **72.1-73.4% A+** | 70.4% A+ |
| 年化 | 98.3% | **165.7%** | 122.8% |
| Sharpe | 2.367 | **2.753** | 2.065 |
| MaxDD | -27.2% | **-11.7%** | -12.5% |
| 特征数 | 69 | 66 (3冗余NaN) | 68 |

**⚠️ 注意: 本表的 73.7% 是 WF-OOS 2024-2026 窗口数字, 不是 Pre-2020 (2018-2019)。** 老版 ng-series.md / specs / CLAUDE.md 曾把此数字误引到 Pre-2020 上下文, 2026-04-20 审计已统一订正; Pre-2020 实测 V5.2=45-55% B (详见 ng-series.md Pre-2020 OOS 小节)。

**Bug#4(revenue_growth修正)是最大贡献**: 模型首次获得真正的成长性信号 (后半段 WF-OOS 收益); 代价是 Pre-2020 regime 下净收益由 +9% 变为 -19% (特征 regime 差异, 非 bug)。
