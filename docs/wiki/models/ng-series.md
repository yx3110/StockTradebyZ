...
1. **ng1.0.1 是唯一双向 A+ 的基座模型** — WF-OOS 79.4% + Pre-2020 73.7%
2. **ng1.0.8 是当前最优生产配置** — 在 ng1.0.1 基座上用组合构建规则降换手+提Sharpe(2.52)
3. ng1.0.5(三层风控) Pre-2020 Sharpe=3.09，风控在熊市中保护资产
4. ng1.0.7/1.0.6 的 regime 改进均在 Pre-2020 退化(C级)，方向已放弃
5. **ng1.0.9 持久特征方向失败** — fast-check ICIR 虚高，生产 Sharpe 仅 0.79
6. **生产推荐**: ng1.0.8 (ng1.0.1 信号 + sell50/cost0.3%/分批调仓)
