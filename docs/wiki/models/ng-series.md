...
**⚠️ 重大发现 (2026-04-10)**:
1. ng1.0.1在Pre-2020也是A+(Sharpe=2.37)——FLIP因子退化担忧不成立
2. ng1.0.5(三层风控)在Pre-2020 Sharpe=3.09甚至超过裸ng1.0.1——风控在2018熊市中保护了资产
3. ng1.0.7条件标签严重过拟合(Pre-2020=C, 年化-36%)
4. ng1.0.6牛熊切换在Pre-2020也差(C级)——切到ng1.0.4(C级)拖累
5. **最终结论: ng1.0.1+ng1.0.5风控overlay是最可靠组合(双向都A+)**
