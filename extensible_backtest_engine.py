...
class V390ModelAdapter(MLModelAdapter):
    ...
    def is_available(self) -> bool:
        ...
        try:
            from ml_models.v39.v390_production_scorer import V390ProductionScorer
            return self.model_path is not None or Path('models/v390_full_from_cache.pkl').exists()
        except ImportError:
            return False
...
class V394ModelAdapter(MLModelAdapter):
    ...
    def is_available(self) -> bool:
        ...
        try:
            from ml_models.v39.v394_production_scorer import V394ProductionScorer
            return self.model_path is not None or Path('models/v394/v394_full_model.pkl').exists()
        except ImportError:
            return False
    ...
    def _initialize_builtin_models(self):
        ...
        builtin_configs = [
            ...
            ModelConfig(
                ...
                model_path_pattern="models/v380/v380_*.pkl",
                features_count=60,
            ...
            ModelConfig(
                ...
                model_path_pattern="models/v390*.pkl",
                features_count=42,
            ...
            ModelConfig(
                ...
                model_path_pattern="models/v394/v394*.pkl",
                features_count=48,
