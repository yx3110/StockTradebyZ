...
DEPRECATED_VERSIONS = {'v2', 'v3', 'v3.1', 'v3.2', 'v3.3', 'v3.4', 'v3.41',
                       ...
                       'v3.8', 'v3.81', 'v3.94', 'v4'}
ACTIVE_VERSIONS = {'v3.9', 'v3.95', 'v3.96', 'v4.0', 'v4.2', 'v4.3'}
...
def main(target_date: str = None, scoring_version: str = "v3", stocks_only: bool = False):
    ...
    if scoring_version in ["v3.6", "v3.7", "v3.8", "v3.81", "v3.9", "v3.94", "v3.95", "v3.96", "v4.0", "v4.2", "v4.3"] and not stocks_only:
        stocks_only = True
...
if __name__ == "__main__":
    ...
    parser.add_argument('--scoring-version', '-v',
                       ...
                       help='评分版本 (默认v3.9)。'
                            ...
                            'v4.2(Hybrid Alpha), v4.3(59特征+强正则+Walk-Forward+4目标)。'
