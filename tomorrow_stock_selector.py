...
SCORER_REGISTRY = {
    ...
    'ng1.0.2': ('ml_models.ng.ng_production_scorer', 'NGProductionScorer',
                ...
                {'model_path': 'ml_models/trained_models/ng/ng_multi_target_20260405_194751.pkl'}, False),
    'ng1.0.3': ('ml_models.ng.ng_production_scorer', 'NGProductionScorer',
                'scoring_engine_v44', 'v44_batch_cache',
                {'model_path': 'ml_models/trained_models/ng/ng103_multi_target_20260407_005245.pkl'}, False),
    # --- V5.0 (独立 engine_attr) ---
...
if __name__ == "__main__":
    ...
    parser.add_argument('--scoring-version', '-v',
                       choices=['v2', 'v3', 'v3.1', 'v3.2', 'v3.3', 'v3.4', 'v3.41',
                                ...
                                'v4', 'v4.0', 'v4.2', 'v4.3', 'v4.4', 'v4.4.2', 'v4.5', 'v4.6', 'v4.7.1', 'v4.7.2', 'v4.7.3', 'v4.7.5', 'v4.7.6', 'v4.7.7', 'v4.7.8', 'v4.7.9', 'v4.8', 'v4.8.0', 'v4.8.1', 'v4.8.2', 'v4.8.4', 'v4.8.5', 'v4.8.6', 'v4.8.7', 'v4.8.8', 'v4.9.0', 'v4.9.0.1', 'v4.9.0.2', 'v4.9.1', 'v5.0', 'ng1.0.0', 'ng1.0.1', 'ng1.0.2', 'ng1.0.3'],
                       default='v4.9.0.1',
