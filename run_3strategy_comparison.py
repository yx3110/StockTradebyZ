...
# -*- coding: utf-8 -*-
"""
3策略对比回测 - 保守、平衡、激进策略在V3.7模型上的表现对比
...
json_file = report_dir / f"strategy_comparison_{ML_VERSION}_{timestamp}.json"
md_file = report_dir / f"strategy_comparison_{ML_VERSION}_{timestamp}.md"
